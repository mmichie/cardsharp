"""
High Card API module for Cardsharp.

This module provides a high-level, platform-agnostic API for working with the
Cardsharp High Card engine, supporting both synchronous and asynchronous operation.
"""
...
class HighCardGame(CardsharpGame):
    """
    High-level, platform-agnostic API for High Card games.

    This class provides a simple interface for creating and running High Card games
    ...
    Example:
        ...
        # Sync usage
        game = HighCardGame(use_async=False)
    ...
    def __init__(
        ...
        """
        Initialize a new High Card game.
        ...
        # Apply default High Card configuration
        default_config = {
            "shuffle_threshold": 5,
            "deal_delay": 0.3,
        }
    ...
    async def initialize(self) -> None:
        """
        Initialize the High Card game and prepare for play.
    ...
    async def shutdown(self) -> None:
        """
        Shut down the High Card game and clean up resources.
        """
    ...
    async def remove_player(self, player_id: str) -> bool:
        """
        Remove a player from the High Card game.
    ...
    async def play_multiple_rounds(self, count: int) -> List[Dict[str, Any]]:
        """
        Play multiple rounds of High Card.
