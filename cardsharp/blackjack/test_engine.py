...
class TestEngine:
    ...
    def _run_python_test(self, test_case: TestCase) -> TestResult:
        ...
        passed = (
            ...
            and actual_outcome == test_case.expected_outcome
            and (
                test_case.expected_value is None
                or actual_value == test_case.expected_value
            )
        )
    ...
    def run_suite(
        self, test_suite: TestSuite, implementation="python"
    ) -> Dict[str, any]:
