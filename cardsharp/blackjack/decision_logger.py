...
class DecisionLogger:
    ...
    def log_decision_point(self, context: DecisionContext):
        ...
        self.logger.debug(f"Valid actions: {[a.value for a in context.valid_actions]}")
        
        if context.chosen_action:
            self.logger.info(
    ...
    def log_split_decision(self, player_name: str, hand: BlackjackHand, 
    ...
    def log_resplit_check(self, player_name: str, current_hands: int, 
                         max_hands: int, allowed: bool):
    ...
    def log_strategy_lookup(self, hand_type: str, dealer_card: str, 
                           action: str, fallback_used: bool = False):
    ...
    def log_hand_transition(self, player_name: str, hand_index: int, 
    ...
    def log_round_start(self, round_num: int, players: List[str]):
        ...
        self.logger.info(f"=== Round {round_num} starting with players: {players} ===")
    ...
    def export_decisions(self, filepath: str):
        ...
        self.logger.info(f"Exported {len(self.decision_history)} decisions to {filepath}")
