#!/usr/bin/env python3
"""
Example demonstrating the use of the HighCardEngine with the immutable state.

This script shows how to use the HighCardEngine class with a platform adapter
to create a complete High Card game.
"""
...
try:
    ...
    from cardsharp.api import HighCardGame
...
async def main():
    ...
    parser.add_argument(
        "-p", "--players", type=int, default=3, help="number of players (default: 3)"
    )
    parser.add_argument(
        "-n",
        "--names",
        ...
        help="names of the players (default: Alice Bob Charlie)",
    )
    parser.add_argument(
