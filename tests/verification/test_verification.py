...
from cardsharp.verification.verifier import (
    VerificationType, VerificationResult, BlackjackVerifier
)
from cardsharp.verification.statistics import StatisticalValidator
from cardsharp.verification.main import (
    VerificationSystem, init_verification, get_verification_system
)
from cardsharp.blackjack.rules import Rules
from cardsharp.blackjack.state_events import (
    patch_game_states, EventEmittingGameState, EventEmittingPlacingBetsState
)
...
class TestVerificationDatabase(unittest.TestCase):
    ...
    def test_database_initialization(self):
        ...
        expected_columns = [
            'session_id', 'timestamp', 'rules_config', 'num_decks', 
            'penetration', 'use_csm', 'player_count', 'seed', 'notes'
        ]
...
class TestStatisticalValidator(unittest.TestCase):
    ...
    def test_calculate_expected_value(self):
        ...
        self.assertEqual(result["expected_value"], 1.0)  # (payout - bet) / bet = (20 - 10) / 10 = 1.0
